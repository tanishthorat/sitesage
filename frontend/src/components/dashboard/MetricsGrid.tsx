...
export default function MetricsGrid({ report, trends, history }: MetricsGridProps) {
  if (!report) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-6">Start by analyzing your first website</p>
        <button
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <LoadTimeCard 
          ...
          history={history.map(h => h.load_time).filter(Boolean).slice(0, 7)}
        />
